Profile: JP_Coverage_eReferral_insurance
Parent: JP_Coverage
...
* payor contains
    insurer 0..1 MS and
    selfPayment 0..1 MS
* payor[insurer] only Reference(JP_Organization_eReferral_coveragePayer)
* payor[insurer] MS
...
* payor[selfPayment] only Reference(JP_Patient_eReferral)
